...
Depth_Of_Coverage=cfg.getint("parameter","Depth Of Coverage")
homozygotes=cfg.get("parameter","Frequency Of Homozygotes")
heterozygotes=cfg.get("parameter","Frequency Of Heterozygotes")
